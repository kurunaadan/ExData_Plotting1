plot4 <- function() {
  ...
  # Subplot (1,1)
  with(power_data,plot(Date_Time,Global_active_power,xlab="",ylab="Global Active Power", type="l"))
  ...
  legend("topright",bty = "n",cex = 0.8,pt.cex=1, lty=c(1,1,1), col = c("black","red","blue"),legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))

  # Subplot (2,2)
  with(power_data,plot(Date_Time,Global_reactive_power,xlab="datetime",ylab="Global_reactive_power", type="l"))
